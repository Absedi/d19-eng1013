# Author: Millie Blank
# Date last-modified: 26/8/2026
# Version number: 3

# ADD NOTES HERE
# GET RID OF DEBUGGING LINES (e.g. print("green light on")) BEFORE SUBMITTING!!
# most recent version
...
# Set pins for TL6 (can change later depending on which pins are actually used)
redTL6Pin = 8
yellowTL6Pin = 9
greenTL6Pin = 10

# Configure pins
board.set_pin_mode_digital_output(redTL6Pin) # red  
board.set_pin_mode_digital_output(yellowTL6Pin) # yellow
board.set_pin_mode_digital_output(greenTL6Pin) # green
...
# Set pins for US5 (can change these later too)
triggerPin = 11
echoPin = 12

# Declare variables to hold US5 data
maxVehicleHeight = 4
heightUS5 = 10 # physical vertical height of US5 gantry (10 is a placeholder)
...
def main():
    ...
    # Set TL6 to red at the beginning? (need to check project brief)
